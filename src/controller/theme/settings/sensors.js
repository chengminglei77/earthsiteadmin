    ...
    function initTable() {//初始化界面（下面的表格）
        tableIns = lovexian.table.init({
            ...
            cols: [[
                ...
                {field: 'longitude', title: '经度', minWidth:100,align:'center'},
                {field: 'latitude', title: '纬度', minWidth:100,align:'center'},
                {field: 'status', title: '状态', minWidth:120,align:'center'},
                {field: 'samplingFrequency', title: '采样频率', minWidth:120,align:'center'},
