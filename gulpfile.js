...
//任务
  ...
  minjs: function(){
    var src = [
      ...
      ,'!./src/lib/extend/baseSetting.js'
      ,'!./src/lib/extend/dragscroll.js'
      ,'!./src/lib/extend/dropdown.js'
      ,'!./src/lib/extend/echartsTheme.js'
      ,'!./src/lib/extend/editor.js'
      ,'!./src/lib/extend/eleTree.js'
      ,'!./src/lib/extend/formSelects.js'
      ,'!./src/lib/extend/loadBar.js'
      ,'!./src/lib/extend/lovexian.js'
      ,'!./src/lib/extend/shiroPermissions.js'
      ,'!./src/lib/extend/treeSelect.js'
      ,'!./src/lib/extend/shiroPermissions.js'
      ,'!./src/lib/extend/validate.js'
    ];
  ...
  ,mv: function(){
    ...
    gulp.src('./src/lib/extend/baseSetting.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/dragscroll.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/dropdown.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/echartsTheme.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/editor.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/eleTree.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/formSelects.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/loadBar.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/lovexian.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/shiroPermissions.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/treeSelect.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
    gulp.src('./src/lib/extend/validate.js')
        .pipe(gulp.dest(destDir + '/lib/extend'));
